...
/**
 * collection of helpers implemented as web UI to provide convenient access to
 * Qanary implementation
 * 
 * @author AnBo
 *
 */
...
public class QanaryWebHelperController {
	...
	/**
	 * get some information about your Qanary implementation using the fancy
	 * HTML template description.html
	 * 
	 * @return
	 */
