...
public class LoggingAspect {
    ...
    @AfterReturning(value = "execution(* *(..)) && @within(LogExecution)", returning = "result")
    public Object logAroundWithAnnotation(ProceedingJoinPoint joinPoint, Object result) throws Throwable {
        Object[] args = joinPoint.getArgs();
        String methodName = joinPoint.getSignature().getName();
