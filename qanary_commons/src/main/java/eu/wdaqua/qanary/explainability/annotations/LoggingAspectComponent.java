//package eu.wdaqua.qanary.explainability.annotations.component;
//
...
//
//    public LoggingAspectComponent() {
//        logger.info("LoggingAspectComponent initialized");
//    }
//
...
//                    logger.info("Found cross-component call processId: {}", processId);
...
//        if (!this.activeTracing) {
//            logger.info("Logging method with not active tracing '{}'", joinPoint.getSignature().getName());
//            Object[] args = joinPoint.getArgs();
//            this.activeTracing = checkForProcessIdAndSetup(args);
//        }
//        if (this.activeTracing) {
//            logger.info("Logging method with active tracing '{}'", joinPoint.getSignature().getName());
