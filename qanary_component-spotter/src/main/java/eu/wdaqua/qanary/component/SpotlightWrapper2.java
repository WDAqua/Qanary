...
@Component
public class SpotlightWrapper2 extends QanaryComponent {
	private static final Logger logger = LoggerFactory.getLogger(SpotlightWrapper2.class);
	/**
	...
	public QanaryMessage process(QanaryMessage myQanaryMessage) {
		...
		//http://admin:admin@localhost:5820/qanary/query
			...
			*/
			SpotlightWrapper2 qaw = new SpotlightWrapper2();
