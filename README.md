...
Qanary is a Methodology for Creating Question Answering Systems it is part of the [WDAqua project](http://wdaqua.informatik.uni-bonn.de) where question answering systems are researched and developed. For all the publications related to Qanary, you can visit: https://scholar.google.de/citations?hl=en&user=23EKFE4AAAAJ&view_op=list_works&sortby=pubdate. Any questions related to Qanary, please send them to: Kuldeep Singh(kskuldeepvit@gmail.com) or Dennis Diefenbach(dennis.diefenbach@univ-st-etienne.fr).
