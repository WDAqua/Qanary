...
public class Alchemy extends QanaryComponent {
	...
	/**
	 * processor of a QanaryMessage, (1.) executes a service call to the Alchemy
	 * service, (2.) parse the data and (3.) sends the retrieved data to the
	 * SPARQL endpoint defined in the Qanary message received
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * parse the XML return of the Alchemy service to return a list of text
	 * selectors
	 * 
	 * @param xmlInput
	 * @param myQuestion
